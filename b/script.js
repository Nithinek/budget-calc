...
// console.log(family['balance']);
greet.innerHTML = `Welcome ${Owner_Name} and Family`;
...
function getBal(balance){
    ...
    if(balance>2000){
        ...
        alt.innerHTML =``;
            ...
            alt.innerHTML =`<p style="color:yellow;">Hello ${Owner_Name}, please Control Your Expenditure......</p>`;
        }    
    }
